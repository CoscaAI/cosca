...
rem (cosca knowledge index) quando o framework muda.
rem
...
rem   - Detecta se arquivos de internal/embed/cosca/ mudaram no ultimo commit
rem   - Se mudou, roda `cosca knowledge index` em BACKGROUND (start /b)
rem     sem travar o commit
...
rem --- COSCA_BIN (env ou default Windows) ---
