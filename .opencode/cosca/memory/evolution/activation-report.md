...
**Action**: Adopt a convention that every package that provides a service (cache, knowledge, config, etc.) must export at least one interface. Add this to `.opencode/cosca/shared/CODING_STANDARDS.md` or equivalent.
...
| Evolution Learnings | `.opencode/cosca/memory/agent/cosca-evolution/learnings.md` |
| Evolution Timeline | `.opencode/cosca/memory/agent/cosca-evolution/evolution.md` |
| Coverage Report | `.opencode/cosca/memory/testing/coverage.md` |
| Bug Registry | `.opencode/cosca/memory/bug/INDEX.md` |
| Codebase Overview | `.opencode/cosca/memory/codebase/overview.md` |
