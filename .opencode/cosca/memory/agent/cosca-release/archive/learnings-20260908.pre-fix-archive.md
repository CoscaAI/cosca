# cosca-release - learnings.md EDITOR PRE-FIX
...
| **Related** | .opencode/cosca/memory/release/activation-report.md, pkg/cosca/cosca.go, .goreleaser.yaml, CHANGELOG.md, .github/workflows/cd.yml |
