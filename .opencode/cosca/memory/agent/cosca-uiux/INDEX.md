...
|------|---------|---------|
| [learnings.md](learnings.md) | Semantic learning journal | 2 entries (seed + activation) |
| [failures.md](failures.md) | Negative memory — failed approaches | 0 failures |
| [patterns.md](patterns.md) | Reusable solution patterns | 2 patterns (cross-surface audit, 3-persona mapping) |
| [evolution.md](evolution.md) | Capability evolution timeline | Level 2 |
| [capability-profile.md](capability-profile.md) | Self-model: strengths, weaknesses, confidence | 4 domains scored |
