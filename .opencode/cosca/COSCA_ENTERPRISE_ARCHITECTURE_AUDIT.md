...
│
├── engines/ (18 engines)
│   ├── discovery/SKILL.md        — Auto-detect framework, language, DB
...
**⚠️ Violação de path**: Linha 50 contém hardcoded path `/home/henrique/.config/opencode/node_modules/cosca-loader/`, violando a política de Virtual Paths introduzida pelo Resource Resolver.
...
|---------|-------|------|----------|
| bootstrap/BOOTSTRAP.md | 50 | `/home/henrique/.config/opencode/node_modules/cosca-loader/` | **SIM** — Viola política de Virtual Paths |
