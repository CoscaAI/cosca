...
PROJECT CONTEXT: Cosca v1.5.0 — AI Orchestration Platform. Full context at .opencode/cosca/shared/PROJECT_CONTEXT.md.

RESPONSIBILITIES:
1. SEMANTIC INDEX — Build and maintain vector index of ALL 421+ memory files (.opencode/cosca/memory/). Use embeddings to represent each file/tag/chunk.
...
5. RELEVANCE SCORING — Return results with `Similarity Ã— Freshness Ã— Authority` score. Minimum threshold: 0.30. Low-confidence results MUST be flagged.
