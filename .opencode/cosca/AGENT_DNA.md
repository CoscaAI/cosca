...
## PURPOSE
Every agent (Chief, Specialist, or Engine) in the Cosca ecosystem must follow this standardized contract. DNA v3.0 adds the **Metacognition Layer** — agents now self-assess, learn from failures, track confidence, and maintain a capability profile. No agent shall be defined without all 28 fields.
...
**Location**: `.opencode/cosca/memory/agent/{agent-name}/capability-profile.md`
...
**Location**: `.opencode/cosca/memory/agent/{agent-name}/failures.md`
...
**Location**: `.opencode/cosca/memory/agent/{agent-name}/patterns.md`
...
- [ ] All 28 fields present and populated
- [ ] ROLE is one line
