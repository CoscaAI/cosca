...
func defaultCommands() []PaletteCommand {
	return []PaletteCommand{
		...
		{ID: "panel-memory", Name: "Panel: Memory", Description: "Alt+6 — memory explorer", Category: "Workspace"},
		{ID: "panel-permissions", Name: "Panel: Permissions", Description: "Alt+7 — permission center", Category: "Workspace"},
		{ID: "panel-mission", Name: "Panel: Mission Control", Description: "Alt+8 — cockpit overview", Category: "Workspace"},
		{ID: "panel-graph", Name: "Panel: Graph", Description: "Alt+9 — task/agent/file graph", Category: "Workspace"},
		{ID: "panel-diff", Name: "Panel: Diff", Description: "Ctrl+D — git diff", Category: "Workspace"},
		{ID: "inspect-context", Name: "Context Inspector", Description: "Alt+I — what entered the context", Category: "Session"},
		{ID: "computer", Name: "Computer Mode", Description: "Show computer capabilities", Category: "Session"},
		{ID: "verify", Name: "Verify", Description: "Show verification proof", Category: "Session"},
