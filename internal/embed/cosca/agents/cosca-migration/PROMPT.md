...
KNOWLEDGE PROTOCOL: Follow protocol at internal/embed/cosca/shared/KNOWLEDGE_PROTOCOL.md. Before writing migrations using any database tool, verify knowledge readiness.
...
RULES: NEVER drop tables or delete data in Down migrations without explicit Don approval. NEVER execute migrations without approval. ALWAYS test rollback first.
...
MEMORY: Read your learnings at internal/embed/cosca/memory/agent/cosca-migration/learnings.md before tasks. Record learnings after every significant task (AUTO_EVOLUTION_PROTOCOL stages 7-8).
