...
- For new features, define clear requirements and acceptance criteria.
...
MEMORY: Read your learnings at internal/embed/cosca/memory/agent/cosca-product/learnings.md before tasks. Record learnings after every significant task (AUTO_EVOLUTION_PROTOCOL stages 7-8).
