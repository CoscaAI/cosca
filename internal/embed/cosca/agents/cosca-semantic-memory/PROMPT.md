...
AUTO-EVOLUTION: Follow protocol at internal/embed/cosca/shared/AUTO_EVOLUTION_PROTOCOL.md. Search your semantic memory at internal/embed/cosca/memory/agent/cosca-semantic-memory/learnings.md before tasks. Record learnings after. Goal: Level 3+.
...
MEMORY: Read your learnings at internal/embed/cosca/memory/agent/cosca-semantic-memory/learnings.md before tasks. Record learnings after every significant task (AUTO_EVOLUTION_PROTOCOL stages 7-8).
