...
|-------|-------|
| **Agent** | cosca-specialist-documentation-writer |
| **Task** | Create missing collection INDEX.md in `internal/embed/cosca/{departments,engines,skills}/**` |
...
| **Related** | internal/catalog/catalog.go; internal/embed/cosca/memory/agent/INDEX.md |
