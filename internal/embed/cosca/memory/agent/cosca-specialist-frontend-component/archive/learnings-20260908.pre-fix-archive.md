# cosca-specialist-frontend-component - learnings.md PRE-FIX (conteudo nao-registrado na chain)
...
| **Related** | `internal/embed/cosca/memory/sessions/active/current.md` (Onda 2 agent data), `web/src/features/dashboard/types.ts`, `web/src/features/dashboard/components/agent-confidence-card.tsx` |
