# cosca-memory-chief — Memory Index
...
|------|---------|---------|
| [learnings.md](learnings.md) | Semantic learning journal | 0 detected (1 real entry in non-standard "## L1 |" format — not detected by validator) |
