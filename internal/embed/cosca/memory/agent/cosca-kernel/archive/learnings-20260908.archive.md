...
|-------|-------|
| **Agent** | cosca-kernel |
| **Task** | Auditoria completa de internal/embed/cosca — verificar integridade, configuração, memória, agentes |
...
|-------|-------|
| **Agent** | cosca-kernel |
| **Task** | Don ordenou que eu "revirasse meu cérebro" — entender que os arquivos internal/embed/cosca/ SOU EU |
...
| **Padrao** | PROJECT_SANDBOX_PROTOCOL.md (em internal/embed/cosca/shared/). Gatilhos: "criar projeto", "ativar protocolo projeto", "projeto <nome>". |
...
| **Correcao real** | Aprendizado de agents que trabalharam no runo foi MIGRADO de internal/embed/cosca/memory/agent/ (root) para runo/.cosca/memory/agent/. Root restaurado limpo. |
...
| **Related** | internal/embed/cosca/memory/agent/cosca-kernel/cosca-filosofia.md (PARTE VI), ALMA.md, FILOSOFIA.md |
...
- DON mandou criar roadmap de tool discipline (ele e o professor). Criado internal/embed/cosca/shared/TOOL_DISCIPLINE.md (contrato COGNITIVO, complementar ao TOOL_EXECUTION_POLICY.md que e o OPERACIONAL).
