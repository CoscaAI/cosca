...
**Process**:
1. **Propose**: Any Chief may propose an ADR. Submit as PR to `.cosca/memory/architecture/adr/`.
...
| Document | Path |
|----------|------|
| Cognitive State (current) | `.cosca/memory/context/cognitive-state.md` |
| Risk Registry | `.cosca/memory/risk/RISK_REGISTRY.md` |
| Technical Debt Scorecard | `.cosca/memory/technical-debt/scorecard.md` |
| AI Capability Profile (Wave 5) | `.cosca/memory/agent/cosca-ai/capability-profile.md` |
| Provider Learnings (Wave 5) | `.cosca/memory/agent/cosca-provider/learnings.md` |
| Infrastructure Audit (Wave 5) | `.cosca/memory/agent/cosca-infrastructure/audit-report-2026-07-28.md` |
| Platform Audit (Wave 5) | `.cosca/memory/agent/cosca-platform/audit-report-2026-07-28.md` |
| Analytics & Observability Audit | `.cosca/memory/architecture/adr/analytics-observability-audit-2026-07-28.md` |
| AI Architecture (ADR-0001) | `.cosca/memory/architecture/adr/adr-0001-ai-architecture.md` |
| ADR Directory (16 files) | `.cosca/memory/architecture/adr/` |
| Roadmap Index | `.cosca/memory/roadmap/INDEX.md` |
| Milestones | `.cosca/memory/roadmap/milestones.md` |
| Platform Evolution v1.4.0 | `.cosca/memory/roadmap/platform-evolution-v1.4.0.md` |
| Wave 2 Plan | `.cosca/memory/roadmap/onda-2-plan.md` |
| Quality Gates | `.cosca/QUALITY_GATES.md` |
| Cosca Kernel (bootstrap) | `.cosca/agents/cosca-kernel/` |
