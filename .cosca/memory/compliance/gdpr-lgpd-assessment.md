...
|-----------|-----------|-------------|-------------|-----------------|
| **Agent Memory** | FileStore (JSON filesystem) | `.cosca/memory/agent/` | ❌ Plaintext | ⚠️ Baixo — agent names, code references, occasional email/username in learnings |
...
| **Session Context** | FileStore | `.cosca/memory/session/` | ❌ Plaintext | ⚠️ Baixo — atualmente vazio |
...
- `.cosca/SECURITY_ARCHITECTURE.md` — Security framework
...
- `.cosca/memory/agent/cosca-security/learnings.md` — Security agent findings
