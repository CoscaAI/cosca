...
| **Related** | .cosca/memory/technical-debt/scorecard.md, .cosca/memory/agent/cosca-evolution/evolution.md |
...
| **Related** | .cosca/memory/technical-debt/scorecard.md §3 Priorities |
