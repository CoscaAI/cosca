...
- Embed sync (`make embed-sync`) — rsync `.cosca/` → `internal/embed/cosca/`
...
| Provider Learnings | `.cosca/memory/agent/cosca-provider/learnings.md` |
| Learning Protocol | `.cosca/memory/LEARNING_PROTOCOL.md` |
| Auto-Evolution Protocol | `.cosca/shared/AUTO_EVOLUTION_PROTOCOL.md` |
