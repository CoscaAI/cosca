# cosca-testing - learnings.md EDITOR PRE-FIX
...
| **Related** | `internal/runtime/state_integration_test.go`, `internal/runtime/runtime_lifecycle_test.go`, `.cosca/memory/testing/integration-report.md` |
