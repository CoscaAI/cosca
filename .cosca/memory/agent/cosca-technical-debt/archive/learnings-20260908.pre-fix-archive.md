...
| **Related** | `.cosca/memory/technical-debt/scorecard.md`, `bug/INDEX.md`, `semantic/INDEX.md`, `risk/RISK_REGISTRY.md`, `agent/cosca-runtime/learnings.md` |
...
- Evidence: scorecard saved at `.cosca/memory/technical-debt/scorecard.md`, cross-references 5+ source documents, scoring formula produces intuitive rankings.
