...
### Artefato principal
`.cosca/engines/evidence/CONFIDENCE_MODEL.md`
...
### Artefato principal
`.cosca/engines/memory-curation/MEMORY_CURATION_ENGINE.md`
...
### Artefatos
51 arquivos: `.cosca/memory/agent/{agent}/capability-profile.md`
...
for agent in $(ls .cosca/memory/agent/); do
  if [ ! -f ".cosca/memory/agent/$agent/capability-profile.md" ]; then
...
### Artefato principal
`.cosca/metrics/platform-health-dashboard.md`
