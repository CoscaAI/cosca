> **Version**: 1.0.0 | **Status**: active | **Owner**: Discovery Chief | **Last Updated**: 2026-07-30
>
> **Preservado de**: `discovery/SKILL.md` v1.0.0 (2026-07-10) — relocado em 2026-07-30 quando o diretório passou a abrigar **duas engines complementares**:
> - `WORKSPACE.md` (este arquivo) — **landscape discovery**: varredura de stack tecnológico do workspace (bootstrap, session_start)
> - [`SKILL.md`](SKILL.md) — **★ F10.3 Discovery Engine**: mineração de serendipidade (insights não-planejados, fim de sprint)
>
> **Regra de coexistência**: ortogonalidade dimensional. A engine de workspace NUNCA analisa insights/learnings; a F10.3 NUNCA varre stack. Cada uma lê fontes disjuntas e roda em triggers distintos.

# WORKSPACE DISCOVERY ENGINE — Landscape Discovery

## PURPOSE
The Workspace Discovery Engine automatically discovers the technology landscape of any workspace. It identifies frameworks, languages, tools, patterns, and structure without manual configuration.
...
- [SKILL.md](SKILL.md) — ★ F10.3 Discovery Engine (serendipity mining) — complementar, dimensão ortogonal
...
| 1.0.0 | 2026-07-30 | Cosca Architecture Chief | Relocated from `SKILL.md` to `WORKSPACE.md` — directory now hosts two complementary engines (landscape vs serendipity). Content integral preservado. |
