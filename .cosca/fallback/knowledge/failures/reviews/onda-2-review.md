...
> **Quality Gate Ref**: `internal/embed/cosca/memory/qa/quality-gates.md` (G0–G9)
...
| Documento | Relação |
|-----------|---------|
| [quality-gates.md](../../../memory/qa/quality-gates.md) | Gates G0–G9 aplicados neste review |
| [CONSTITUTION.md](../../../CONSTITUTION.md) | P1 (Segurança), P2 (Código é verdade), P6 (Evolução sem Regressão) |
| [CI.md](../../../../../Makefile) | Runbook do CI — precisa de atualização (issues #4, #5, #6 resolvidos) |
| [onda-2-plan.md](../../../memory/roadmap/onda-2-plan.md) | Plano original da Onda 2 |
| [bug/INDEX.md](../../../memory/INDEX.md) | Bug registry — B-U01, B-U02, B-U03 precisam ser formalizados |
