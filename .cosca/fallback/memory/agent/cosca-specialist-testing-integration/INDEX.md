# cosca-specialist-testing-integration — Memory Index
...
|------|---------|---------|
| [learnings.md](learnings.md) | Semantic learning journal | 2 entries (1 seed + 1 suite) |
...
| [capability-profile.md](capability-profile.md) | Self-model: strengths, weaknesses, confidence | 1 domains scored |
