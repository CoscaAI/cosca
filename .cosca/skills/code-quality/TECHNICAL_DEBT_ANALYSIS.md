...
- [ ] Debt score calculated via golangci-lint + gocyclo + deadcode analysis. Baseline recorded in .cosca/memory/evolution/learnings.md. Score must decrease or remain stable in subsequent analyses.
