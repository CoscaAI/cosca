...
## 2. O método em 6 passos (checklist da casa)
...
## 3. Fronteira de autoridade — o que a capacidade externa NUNCA ganha
...
## 4. Ledger de mineração — o que o Cosca absorveu até aqui
...
## 5. Precedente concreto — a mineração LLRT → ganho real medido
...
## 6. Escopo / o que NÃO fazer (disciplina)
...
2. **Manter o ledger** (§4) como fonte de verdade do que foi absorvido, com proveniência.
